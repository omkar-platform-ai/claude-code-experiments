...
/**
 * Maps raw tool names and their args to user-friendly labels.
 * e.g. "str_replace_editor" with command "create" and path "/App.jsx" → "Created /App.jsx"
 */
                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolLabel = getToolLabel(tool.toolName, tool.args);
                            return (
